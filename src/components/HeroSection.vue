  ...
  <section id="home" class="hero" aria-label="Intro">
    <div class="container hero__grid">
      ...
      <div class="hero__content">
        ...
        <h1 class="hero__name reveal reveal-delay-1">Xenios Gerolemou</h1>

        <div class="hero__role-wrapper reveal reveal-delay-2">
          <span class="hero__role"
            >Backend &amp; Distributed Systems Engineer</span
          >
        </div>
        ...
        <div class="hero__socials reveal reveal-delay-4">
          <a
      ...
      <!-- Photo -->
      <div class="hero__photo-wrapper reveal reveal-delay-2">
        <div class="hero__photo-frame">
          <img
            src="@/assets/perfil.png"
            alt="Photo of Xenios Gerolemou"
            class="hero__photo"
            width="400"
            height="400"
            fetchpriority="high"
        ...
        <div class="hero__photo-meta">
          <span class="hero__location">
            ...
            >
              <path
                d="M12 2C8.686 2 6 4.686 6 8c0 5.25 6 14 6 14s6-8.75 6-14c0-3.314-2.686-6-6-6zm0 8a2 2 0 1 1 0-4 2 2 0 0 1 0 4z"
                fill="currentColor"
              />
            </svg>
            Nicosia · Cyprus
